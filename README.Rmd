...
built upon the ['GA' package](https://CRAN.R-project.org/package=GA). It provides a comprehensive, flexible, and modular 
...
> Benitez F., Pinto-Roa Diego P. (2023). _rmoo: Multi-Objective Optimization in R_. 
